...
while True:
    ...
    if choose == 1:
        To_encrypt = input("Type text that u wanna encrypt: \n")

        while True:
            try:
                encrypt_key = int(input("Type encrypt key (1-9): "))
        ...
        while True:
            try:
                decrypt_key = int(input("Type your decrypt key (1-9): "))
        ...
        print("Wait a sec :3\n")
        time.sleep(1)
        print("here is yours decrypted text:")
        print(decrypted)
